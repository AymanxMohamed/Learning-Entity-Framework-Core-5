...
namespace WizLib_DataAccess.Migrations
{
    ...
    [Migration("20220513152337_MakkingBOokDetailIdNullable")]
    partial class MakkingBOokDetailIdNullable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WizLib_Model.Models.Book", b =>
                {
                    ...
                    b.HasIndex("BookDetailsId")
                        .IsUnique()
                        .HasFilter("[BookDetailsId] IS NOT NULL");
            ...
            modelBuilder.Entity("WizLib_Model.Models.FluentBookAuthor", b =>
                {
                    b.Property<int>("FluentBookId")
                        .HasColumnType("int");

                    b.Property<int>("FluentAuthorId")
                        .HasColumnType("int");

                    b.HasKey("FluentBookId", "FluentAuthorId");
            ...
            modelBuilder.Entity("WizLib_Model.Models.FluentBook", b =>
                {
                    ...
                    b.HasOne("WizLib_Model.Models.FluentPublisher", "FluentPublisher")
            ...
            modelBuilder.Entity("WizLib_Model.Models.FluentBookAuthor", b =>
                {
                    b.HasOne("WizLib_Model.Models.FluentAuthor", "FluentAuthor")
                        .WithMany("FluentBookAuthors")
                        .HasForeignKey("FluentAuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WizLib_Model.Models.FluentBook", "FluentBook")
                        .WithMany("FluentBookAuthors")
                        .HasForeignKey("FluentBookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
